...
export default function UserDropdown() {
  ...
  // Hàm decode token an toàn (không crash nếu token null hoặc lỗi)
  ...
  // Ưu tiên lấy tên theo thứ tự hợp lý nhất
  const displayName =
    ...
    <div className="relative">
      ...
      >
        <button
          ...
          className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-left font-medium text-gray-700 text-theme-sm hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
        >
          <svg
