...
const Badge: React.FC<BadgeProps> = ({
  ...
  const baseStyles =
    "inline-flex items-center justify-center gap-1 rounded-full font-bold"; // font-bold để chữ đậm hơn

  // Cỡ chữ lớn hơn
  const sizeStyles = {
    sm: "text-base px-3 py-1", // badge nhỏ nhưng vẫn rõ
    md: "text-lg px-4 py-1.5", // badge to rõ ràng hơn
  };
